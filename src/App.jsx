...
function ReceiptEditor({ room, receipt, receiptImage, isParsing, ocrError, viewerId, onUpload, onAnalyze, onManualReceipt, onPasteReceipt, onItemChange, onFeeChange, onAddItem, onToggleAssignment }) {
  ...
  return <div className="receipt-column">
    ...
    {isParsing && <div className="parsing-card" role="status" aria-live="polite"><span className="loader" /><div><strong>Finding the details</strong><span>Looking for items, quantities, and totals…</span></div><div className="skeleton" style={{width:'100%',marginTop:8}} /></div>}
